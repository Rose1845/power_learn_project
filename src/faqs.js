export const faqs=[
    {
        ...
        answer:'Hello ⚡ Thank you for your interest in Power Learn Project. Unfortunately, applications are closed. You can apply for the next cohort later in the year. Meanwhile join our community channel here: https://bit.ly/3NFmyCn to be updated first when applications open for the second cohort.'

    },
    {
        question:'What modules would I learn in the software development course?',
        answer:'You will take Four technical modules i.e Python Programming Dart Programming Database development Web development And one additional soft skills module for Personal development and Entrepreneurship'
